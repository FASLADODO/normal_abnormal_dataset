...
joints([14*3+1:14*3+3],:)=AnkleRigth;
joints([18*3+1:18*3+3],:)=AnkleLeft;
% joints([5*3+1:5*3+3],:) = ElbowRight;
% joints([9*3+1:9*3+3],:)=ElbowLeft;
joints([15*3+1:15*3+3],:)=FootRight;
joints([19*3+1:19*3+3],:)=FootLeft;
...
joints([12*3+1:12*3+3],:)=HipRight;
joints([16*3+1:16*3+3],:)=HipLeft;    
joints([13*3+1:13*3+3],:)=KneeRight;
joints([17*3+1:17*3+3],:)=KneeLeft;
