...
coeff_res=50;
train=load('final_for_test_all.mat');
train=train.final_for_train;
persons=fieldnames(train);
% 
              ...
              switch k
                  case 1 %'LFD'
                     ...
                     %   left_feet_Z=left_feet_Z(flipud(w(:,2)));
                        ...
                        train_for_model_LFD{counter_lfd}=[selected_joints];
                        set(M, {'color'}, {[1 0 0];[0 1 0];[0 0 1]});
                        suptitle('LFD Right')
                        counter_lfd=counter_lfd+1;
                  ...
                  case 2% 'LKI'
                      ...
                      %  left_feet_Z=left_feet_Z(flipud(w(:,2)));
                        ...
                        suptitle('LKI Left')
                         ...
                         set(M, {'color'}, {[1 0 0];[0 1 0];[0 0 1]});
                        suptitle('LKI Right')
                        train_for_model_LKI{counter_lki}=selected_joints;
                        counter_lki=counter_lki+1;
...
%                        if var_cont~=0   
                         train_for_model_normal{counter_normal}=selected_joints;
                  ...
                  case 4 %'RFD'
                      ...
                      figure(4)
                        ...
                        set(M, {'color'}, {[1 0 0];[0 1 0];[0 0 1]});
                        suptitle('RFD  Left')
                        train_for_model_RFD{counter_rfd}=selected_joints;
                        counter_rfd=counter_rfd+1;
                  ...
                  case 3% 'RKI'
                    ...
                    set(M, {'color'}, {[1 0 0];[0 1 0];[0 0 1]});
                    suptitle('RKI  Left')  
                    train_for_model_RKI{counter_rki}=selected_joints;
                    counter_rki=counter_rki+1;
